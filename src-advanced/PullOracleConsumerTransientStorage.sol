...
/**
 * @title PullOracleConsumerTransientStorage
 * @notice Storage-backed configurable base for transient-optimized Pull Oracle consumers
 * @dev Combine EIP-1153 transient storage batch lookups from PullOracleConsumerTransient
 *      with mutable persistent storage for runtime configuration governance.
 *
 *      Storage Layout:
 ...
 */
abstract contract PullOracleConsumerTransientStorage is PullOracleConsumerTransient, IPullOracleConsumerStorage {
